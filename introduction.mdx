...
<CardGroup cols={2}>
  ...
  <Card title="Security First" icon="shield-check">
    Static validation, VirusTotal scanning, AI security review, and agent-specific trust scoring on every submission. External skills are cached by content hash for speed.
  </Card>
</CardGroup>

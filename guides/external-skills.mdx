...
**Edit detection works the same way.** If you've modified the installed files, `ap update` detects the hash mismatch and skips the skill with a yellow "locally edited" warning.

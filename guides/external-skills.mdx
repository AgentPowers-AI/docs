...
**Preview before installing** — Use `ap scan` to run the full security pipeline without installing:

```bash
ap scan ontology --source clawhub
```

This downloads to a temporary sandbox, scans, displays results, and cleans up. Nothing is installed.

...
**Locally edited skills are protected.** If you've modified an installed skill's files, `ap update` detects the change via content hash and skips it to avoid overwriting your work. You'll see a yellow "locally edited" notice. This applies to both native and external skills.

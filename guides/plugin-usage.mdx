...
Returns the full description, price, security status, version, author, and download count. Supports an optional `source` parameter to look up skills from specific sources.

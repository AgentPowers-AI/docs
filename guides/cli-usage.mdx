...
Returns a unified table with columns: Slug, Title, Source, Type, Price, Security. Results are sectioned by source -- AgentPowers native skills appear first, followed by external sources like ClawHub. Install counts and star ratings are shown inline in the Title column when available.
